...
- Name: EndToEndPO.spec.js >> @web end to end test with ADIDAS ORIGINAL
- Location: tests\EndToEndPO.spec.js:8:1
...
Call log:
  - waiting for getByRole('button', { name: 'login' })
    - locator resolved to <input id="login" name="login" type="submit" value="Login" _ngcontent-vca-c31="" class="btn btn-block login-btn"/>
      ...
      - generic [ref=e31]:
        ...
        - generic [ref=e33]:
          - generic [ref=e34]:
            ...
            - textbox "email@example.com" [ref=e36]: annamaarna09@gmail.com
          - generic [ref=e37]:
            - generic [ref=e38]: Password
            - textbox "enter your passsword" [active] [ref=e39]: S.veena@1217
