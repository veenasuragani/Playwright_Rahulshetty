...
- Name: EndToEndPO.spec.js >> @web end to end test with ZARA COAT 3
...
Call log:
  - waiting for getByRole('button', { name: 'login' })
    - locator resolved to <input id="login" name="login" type="submit" value="Login" _ngcontent-aav-c31="" class="btn btn-block login-btn"/>
      ...
      - generic [ref=e31]:
        ...
        - generic [ref=e33]:
          - generic [ref=e34]:
            ...
            - textbox "email@example.com" [ref=e36]: suragani.veena@gmail.com
          - generic [ref=e37]:
