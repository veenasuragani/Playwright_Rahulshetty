...
Call log:
  - waiting for getByRole('listitem').getByRole('button', { name: 'Cart' })
    - locator resolved to <button tabindex="0" _ngcontent-rxh-c38="" class="btn btn-custom" routerlink="/dashboard/cart">…</button>
...
- generic [active] [ref=e1]:
  ...
  - alert "Product Added To Cart" [ref=e141] [cursor=pointer]
```
